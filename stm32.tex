...
To do it, signal must be reduced from continuous-time to discrete-time.
This process is called sampling and requires reading value of the signal in equal intervals of time.
To establish proper samping frequency we need concept of Nyquist frequency.
It determines minimum sampling frequency of the system based on maximum frequency of the signal.
