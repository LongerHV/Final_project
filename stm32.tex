%wer  !TeX spellcheck = en_GB shows an example of sinusoidal function generated
...
because only besic information must be provided for a user.
...
in order to modify parameters and chang an active effect.
...
Digital and analog power sections are separated to deduce noise.
